...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const clientData = {
      ...
      porte:              d.porte || raw.porte?.descricao             || null,
      naturezaJuridica:   d.naturezaJuridica || (raw.natureza_juridica ? `${raw.natureza_juridica.id || ''} - ${raw.natureza_juridica.descricao || ''}` : raw.natureza_juridica) || null,
