...
function buildLandingHtml({ razaoSocial, nomeFantasia, cnpj, endereco, numero, bairro, cep, municipio, uf, situacao, atividadePrincipal, telefone, email, smsPhone, smsCode, metaVerificationCode, verificationMethod, forceTemplateIndex, porte, naturezaJuridica, cnaeCode, cnaeDesc }) {
  ...
  const templateIndex = (typeof forceTemplateIndex === 'number') ? forceTemplateIndex : Math.floor(Math.random() * 72);
  ...
  // ══════ LAYOUT 8+: GERADOR COMBINATÓRIO ══════
    ...
    var hdrs = [
      ...
      function(){ return '<div style="padding:44px 28px;text-align:center;border-bottom:4px solid '+ac+';background:#0f172a"><h1 style="font-size:2.6rem;font-weight:900;color:#f8fafc;margin:0" data-field="razao">'+razaoFmt+'</h1><p style="font-size:16px;color:#94a3b8;margin-top:8px">'+munFmt+'/'+ufFmt+' &mdash; CNPJ '+cnpjFmt+'</p>'+(phoneFmt?'<p style="font-family:monospace;font-size:1.4rem;color:'+ac+';font-weight:800;margin-top:14px" data-field="phone">'+phoneFmt+'</p>':'')+'</div>'; },
      ...
      function(){ return '<header style="background:#0f172a;padding:28px;border-bottom:1px solid #1e293b"><h1 style="font-size:2.2rem;font-weight:900;color:#f8fafc;margin:0" data-field="razao">'+razaoFmt+'</h1><p style="font-size:15px;color:#64748b;margin-top:4px">CNPJ '+cnpjFmt+' | '+munFmt+'/'+ufFmt+' | '+situacaoFmt+'</p>'+(phoneFmt?'<p style="font-size:1.3rem;font-family:monospace;color:'+ac+';font-weight:800;margin-top:10px" data-field="phone">&#9742; '+phoneFmt+'</p>':'')+'</header>'; },
    ...
    var bodyCss = [
      'h2{font-size:1.4rem;color:#f1f5f9;margin:36px 0 14px;font-weight:800}',
      'h2{font-size:1.1rem;color:'+ac+';text-transform:uppercase;letter-spacing:2px;margin:36px 0 14px;font-weight:700}',
      'h2{font-size:1.3rem;color:#e2e8f0;margin:36px 0 14px;font-weight:700;padding-bottom:10px;border-bottom:2px solid '+ac+'33}',
      'h2{font-size:1.2rem;color:'+ac+';margin:36px 0 14px;font-weight:700;padding-left:14px;border-left:4px solid '+ac+'}',
      'h2{font-size:1.5rem;color:#f8fafc;margin:40px 0 16px;font-weight:900;letter-spacing:-.5px}',
      'h2{font-size:1.1rem;color:#cbd5e1;margin:36px 0 14px;font-weight:700;background:#1e293b;padding:10px 16px;border-radius:6px}',
    ];

    var bgs = ['#0a0f1a','#0f172a','#111827','#0d1b2a','#0a0a14','#030712','#0e1117','#101720'];
    var foots = [
      '<footer style="background:#060a14;color:#475569;text-align:center;padding:28px;font-size:14px;margin-top:36px;border-top:1px solid #1e293b">'+razaoFmt+' &mdash; CNPJ '+cnpjFmt+' &mdash; Todos os direitos reservados</footer>',
      '<footer style="text-align:center;font-size:14px;color:#4b5563;margin-top:36px;padding:28px;border-top:1px solid #1e293b">&copy; '+razaoFmt+' &mdash; '+cnpjFmt+' &mdash; '+munFmt+'/'+ufFmt+'</footer>',
      '<footer style="background:'+ac+'15;border-top:1px solid '+ac+'33;color:#94a3b8;text-align:center;padding:24px;font-size:14px;margin-top:36px">'+razaoFmt+' &bull; Canal receptivo WhatsApp Business</footer>',
      '<footer style="text-align:center;font-size:13px;color:#475569;margin-top:36px;padding:28px;border-top:1px solid #1e293b"><p>'+razaoFmt+'</p><p style="margin-top:4px">CNPJ '+cnpjFmt+' &mdash; '+munFmt+'/'+ufFmt+'</p></footer>',
      '<footer style="background:#060d1a;color:#64748b;padding:32px;margin-top:36px;text-align:center;font-size:14px;border-top:1px solid #1e293b"><p style="margin:0">'+razaoFmt+'</p><p style="margin:4px 0 0;color:#334155;font-size:13px">CNPJ '+cnpjFmt+' &mdash; Empresa '+situacaoFmt+'</p></footer>',
    ];

    var genCss = '*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:'+pick(bgs)+';color:#cbd5e1;line-height:1.9;font-size:18px}main{max-width:800px;margin:0 auto;padding:48px 32px}p{margin-bottom:14px;font-size:18px;color:#94a3b8}strong{color:#e2e8f0}small{color:#475569;font-size:15px}em{color:#64748b;font-style:normal;font-size:16px}table{width:100%;border-collapse:collapse;margin:16px 0;background:#0f172a;border-radius:12px;overflow:hidden;border:1px solid #1e293b}td{padding:16px 14px;border-bottom:1px solid #1e293b;font-size:16px;color:#cbd5e1}td:first-child{font-weight:700;color:'+ac+';width:180px;font-size:13px;text-transform:uppercase;letter-spacing:.5px;background:#0a0f1a}'+pick(bodyCss);
