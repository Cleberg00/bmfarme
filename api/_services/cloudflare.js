...
function buildLandingHtml({ razaoSocial, nomeFantasia, cnpj, endereco, numero, bairro, cep, municipio, uf, situacao, atividadePrincipal, telefone, email, smsPhone, smsCode, metaVerificationCode, verificationMethod, forceTemplateIndex, porte, naturezaJuridica, cnaeCode, cnaeDesc }) {
  ...
  if (layoutType === 0) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#333;line-height:1.8;font-size:18px}header{background:'+ac+';color:#fff;padding:20px 32px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px}header h1{font-size:1.4rem;font-weight:700}header span{font-size:14px;opacity:.85}.banner{background:#f8fafc;padding:48px 32px;text-align:center;border-bottom:1px solid #e5e7eb}.banner h2{font-size:2.4rem;font-weight:900;color:#111;margin-bottom:8px}.banner p{font-size:18px;color:#6b7280;max-width:600px;margin:0 auto}'+(phoneFmt?'.banner .phone{font-family:monospace;font-size:1.5rem;color:'+ac+';font-weight:800;margin-top:16px}':'')+'main{max-width:800px;margin:0 auto;padding:40px 24px}section{margin-bottom:36px}h3{font-size:1.2rem;color:#111;margin-bottom:12px;font-weight:700}p{margin-bottom:12px}small{color:#6b7280;font-size:15px}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:12px 10px;border-bottom:1px solid #f1f5f9;font-size:16px}td:first-child{font-weight:700;color:#6b7280;width:160px}footer{background:#111;color:#9ca3af;text-align:center;padding:20px;font-size:14px}';
  ...
  // ══════ LAYOUT 1: ONE-PAGE MODERNO ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#1a1a1a;line-height:1.9;font-size:18px}.hero{min-height:40vh;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;padding:60px 24px;background:linear-gradient(160deg,#f8fafc 0%,#e2e8f0 100%)}.hero h1{font-size:2.6rem;font-weight:900;color:#0f172a;margin-bottom:8px}.hero .tagline{font-size:1.1rem;color:#475569;margin-bottom:16px}'+(phoneFmt?'.hero .cta{background:'+ac+';color:#fff;padding:12px 32px;border-radius:8px;font-size:1rem;font-weight:700;text-decoration:none;display:inline-block;margin-top:8px;font-family:monospace}':'')+'main{max-width:720px;margin:0 auto;padding:40px 24px}h2{font-size:1.4rem;color:#0f172a;margin:36px 0 14px;font-weight:700}p{margin-bottom:14px}em{color:#6b7280;font-style:normal;font-size:16px}table{width:100%;border-collapse:collapse;margin:12px 0;font-size:17px}td{padding:12px 10px;border-bottom:1px solid #f1f5f9}td:first-child{font-weight:600;color:#475569;width:180px}footer{border-top:1px solid #e5e7eb;text-align:center;padding:24px;font-size:15px;color:#6b7280;margin-top:40px}';
  ...
  // ══════ LAYOUT 2: CORPORATIVO DARK ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#0f172a;color:#cbd5e1;line-height:1.8;font-size:17px}.top{padding:48px 24px;text-align:center;border-bottom:1px solid #1e293b}.top h1{font-size:2.4rem;font-weight:900;color:#f8fafc;letter-spacing:-1px}.top p{color:#94a3b8;margin-top:8px;font-size:16px}'+(phoneFmt?'.top .ph{color:'+ac+';font-family:monospace;font-size:1.4rem;font-weight:800;margin-top:14px;display:block}':'')+'main{max-width:720px;margin:0 auto;padding:36px 24px}h2{color:'+ac+';font-size:1rem;text-transform:uppercase;letter-spacing:2px;margin:32px 0 12px;font-weight:700}p{margin-bottom:12px}strong{color:#f1f5f9}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:12px 10px;border-bottom:1px solid #1e293b;font-size:16px;color:#cbd5e1}td:first-child{color:#94a3b8;font-weight:600;width:160px}small{color:#64748b;font-size:15px}footer{text-align:center;padding:20px;font-size:14px;color:#475569;border-top:1px solid #1e293b;margin-top:24px}';
  ...
  // ══════ LAYOUT 3: PORTAL COM SIDEBAR ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#f9fafb;color:#333;line-height:1.8;font-size:17px;display:flex;min-height:100vh}@media(max-width:768px){body{flex-direction:column}}aside{width:280px;background:#1e293b;color:#fff;padding:32px 20px;flex-shrink:0}@media(max-width:768px){aside{width:100%;padding:20px}}aside h1{font-size:1.2rem;font-weight:700;margin-bottom:8px}aside .meta{font-size:14px;color:#94a3b8;line-height:1.6;margin-bottom:16px}'+(phoneFmt?'aside .phone{font-family:monospace;color:'+ac+';font-size:1.1rem;font-weight:700;background:rgba(255,255,255,.06);padding:10px;border-radius:6px;text-align:center;margin-bottom:12px}':'')+'aside nav{margin-top:16px}aside nav a{display:block;color:#cbd5e1;text-decoration:none;padding:8px 0;border-bottom:1px solid #334155;font-size:15px}main{flex:1;padding:36px 28px;max-width:740px}h2{font-size:1.3rem;color:#111;margin:28px 0 12px;font-weight:700}p{margin-bottom:12px}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:12px 10px;border-bottom:1px solid #f1f5f9;font-size:16px}td:first-child{font-weight:600;color:#6b7280;width:160px}small{color:#6b7280;font-size:15px}';
  ...
  // ══════ LAYOUT 4: EDITORIAL/BLOG ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:Georgia,serif;background:#fff;color:#1a1a1a;line-height:2;font-size:17px}article{max-width:660px;margin:0 auto;padding:56px 24px}h1{font-size:2.4rem;font-weight:700;letter-spacing:-1px;margin-bottom:4px;color:#000}.byline{font-size:16px;color:#6b7280;margin-bottom:36px;font-family:sans-serif;border-bottom:1px solid #e5e7eb;padding-bottom:16px}h2{font-size:1.4rem;color:#000;margin:36px 0 12px;font-weight:600}p{margin-bottom:14px}em{font-style:normal;color:#6b7280;font-size:16px;font-family:sans-serif}'+(phoneFmt?'.contact-box{background:#f8fafc;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin:20px 0;text-align:center}.contact-box .num{font-family:monospace;font-size:1.4rem;color:'+ac+';font-weight:800}':'')+'small{color:#9ca3af;font-size:15px;font-family:sans-serif}footer{font-family:sans-serif;text-align:center;font-size:14px;color:#9ca3af;margin-top:48px;padding-top:16px;border-top:1px solid #f1f5f9}';
    return headHtml+'<style>'+css+'</style></head><body><article><h1 data-field="razao">'+razaoFmt+'</h1><div class="byline">'+munFmt+'/'+ufFmt+' &bull; CNPJ '+cnpjFmt+' &bull; '+situacaoFmt+'</div>'+aboutNatural+(phoneFmt?'<div class="contact-box"><p style="font-size:16px;color:#6b7280;margin-bottom:8px;font-family:sans-serif">WhatsApp Business</p><div class="num" data-field="phone">'+phoneFmt+'</div></div>':'')+'<h2>Dados Oficiais</h2>'+tblData+'<h2>Canal de Atendimento</h2>'+contactNatural+'<h2>Compliance e Privacidade</h2>'+complianceCompact+'<footer>'+razaoFmt+' &mdash; '+cnpjFmt+'</footer></article>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 5: CARTÃO DE VISITA DIGITAL ══════
  else if (layoutType === 5) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:linear-gradient(160deg,#667eea22,#764ba222);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px}.card{background:#fff;max-width:520px;width:100%;border-radius:16px;box-shadow:0 20px 60px rgba(0,0,0,.1);overflow:hidden}.card-top{background:'+ac+';padding:32px 28px;color:#fff;text-align:center}.card-top h1{font-size:1.8rem;font-weight:800;margin-bottom:4px}.card-top p{font-size:15px;opacity:.85}'+(phoneFmt?'.card-top .phone{font-family:monospace;font-size:1.3rem;font-weight:800;margin-top:12px;background:rgba(255,255,255,.2);display:inline-block;padding:8px 20px;border-radius:24px}':'')+ '.card-body{padding:28px}.card-body p{font-size:16px;color:#475569;margin-bottom:10px;line-height:1.7}.card-body strong{color:#111}table{width:100%;border-collapse:collapse;margin:12px 0;font-size:15px}td{padding:12px 8px;border-bottom:1px solid #f1f5f9}td:first-child{color:#6b7280;font-weight:600;width:140px}small{color:#9ca3af;font-size:14px}.card-foot{background:#f8fafc;padding:14px;text-align:center;font-size:13px;color:#6b7280}';
  ...
  // ══════ LAYOUT 6: GOVERNO/CONSULTA PÚBLICA ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#333;line-height:1.7;font-size:17px}.header{background:#fff;border-bottom:2px solid #111;padding:20px 24px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;max-width:860px;margin:0 auto}.header h1{font-size:1.1rem;font-weight:800;color:#111;text-transform:uppercase;letter-spacing:.5px}.header span{font-size:14px;color:#6b7280}.body{max-width:860px;margin:0 auto;padding:28px 24px}h2{font-size:16px;color:#111;text-transform:uppercase;letter-spacing:1px;margin:28px 0 12px;padding-bottom:8px;border-bottom:1px solid #ddd;font-weight:700}table{width:100%;border-collapse:collapse;margin:8px 0}th,td{text-align:left;padding:10px;border:1px solid #e5e7eb;font-size:16px}th{background:#f8fafc;font-weight:700;color:#374151;width:180px}p{margin-bottom:10px;font-size:16px}small{color:#6b7280;font-size:15px}'+(phoneFmt?'.phone-row{font-family:monospace;color:'+ac+';font-weight:700;font-size:1.1rem}':'')+'footer{max-width:860px;margin:0 auto;text-align:center;padding:16px 24px;font-size:13px;color:#9ca3af;border-top:2px solid #111}';
  ...
  // ══════ LAYOUT 7: LANDING PAGE COM CTA ══════
    ...
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#333;line-height:1.8;font-size:18px}.hero{background:linear-gradient(135deg,'+ac+' 0%,'+ac+'dd 100%);padding:56px 24px;text-align:center;color:#fff}.hero h1{font-size:2.6rem;font-weight:900;margin-bottom:8px}.hero p{font-size:18px;opacity:.9;max-width:500px;margin:0 auto 20px}'+(phoneFmt?'.hero .btn{display:inline-block;background:#fff;color:'+ac+';padding:14px 36px;border-radius:8px;font-size:1.1rem;font-weight:800;font-family:monospace;text-decoration:none}':'')+'main{max-width:760px;margin:0 auto;padding:40px 24px}h2{font-size:1.3rem;color:#111;margin:32px 0 12px;font-weight:700}p{margin-bottom:12px}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:12px 10px;border-bottom:1px solid #f1f5f9;font-size:17px}td:first-child{font-weight:600;color:#6b7280;width:170px}small{color:#6b7280;font-size:15px}footer{background:#f8fafc;text-align:center;padding:24px;font-size:14px;color:#6b7280;border-top:1px solid #e5e7eb}';
  ...
  // ══════ LAYOUT 8+: GERADOR COMBINATÓRIO ══════
    ...
    var hdrs = [
      function(){ return '<div style="background:linear-gradient(135deg,'+ac+','+ac+'bb);color:#fff;padding:40px 24px;text-align:center"><h1 style="font-size:2.2rem;font-weight:900;margin:0" data-field="razao">'+razaoFmt+'</h1><p style="font-size:16px;opacity:.85;margin-top:6px">'+munFmt+'/'+ufFmt+' &mdash; CNPJ '+cnpjFmt+'</p>'+(phoneFmt?'<p style="font-family:monospace;font-size:1.3rem;font-weight:800;margin-top:14px" data-field="phone">'+phoneFmt+'</p>':'')+'</div>'; },
      function(){ return '<div style="background:#0f172a;color:#fff;padding:28px 24px;text-align:center"><h1 style="font-size:2rem;font-weight:900;margin:0" data-field="razao">'+razaoFmt+'</h1><p style="font-size:15px;color:#94a3b8;margin-top:6px">CNPJ '+cnpjFmt+' &bull; '+munFmt+'/'+ufFmt+'</p>'+(phoneFmt?'<p style="font-family:monospace;color:'+ac+';font-size:1.2rem;font-weight:800;margin-top:10px" data-field="phone">'+phoneFmt+'</p>':'')+'</div>'; },
    ...
    var foots = [
      '<div style="background:#0f172a;color:#94a3b8;text-align:center;padding:16px;font-size:14px;margin-top:32px">'+razaoFmt+' &mdash; CNPJ '+cnpjFmt+'</div>',
      '<div style="text-align:center;font-size:14px;color:#9ca3af;margin-top:32px;padding:16px;border-top:1px solid #e5e7eb">&copy; '+razaoFmt+' &mdash; '+cnpjFmt+'</div>',
      '<div style="background:'+ac+';color:#fff;text-align:center;padding:14px;font-size:14px;margin-top:32px">'+razaoFmt+' &bull; '+munFmt+'/'+ufFmt+'</div>',
    ];

    var genCss = '*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:'+pick(bgs)+';color:#333;line-height:1.8;font-size:17px}main{max-width:740px;margin:0 auto;padding:32px 24px}p{margin-bottom:12px}strong{color:#111}small{color:#6b7280;font-size:15px}em{color:#6b7280;font-style:normal;font-size:16px}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:12px 10px;border-bottom:1px solid #f1f5f9;font-size:16px}td:first-child{font-weight:600;color:#6b7280;width:160px}'+pick(bodyCss);
