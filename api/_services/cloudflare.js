...
function buildLandingHtml({ razaoSocial, nomeFantasia, cnpj, endereco, numero, bairro, cep, municipio, uf, situacao, atividadePrincipal, telefone, email, smsPhone, smsCode, metaVerificationCode, verificationMethod, forceTemplateIndex, porte, naturezaJuridica, cnaeCode, cnaeDesc }) {
  ...
  // ══════ LAYOUT 0: SITE INSTITUCIONAL PREMIUM ══════
  if (layoutType === 0) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#1e293b;line-height:1.9;font-size:18px}nav{background:#fff;padding:18px 32px;border-bottom:1px solid #e2e8f0;display:flex;justify-content:space-between;align-items:center;position:sticky;top:0;z-index:10}nav h1{font-size:1.3rem;font-weight:800;color:'+ac+'}nav span{font-size:14px;color:#64748b}.hero{padding:80px 32px 64px;text-align:center;background:linear-gradient(180deg,#f8fafc 0%,#fff 100%)}.hero h2{font-size:3rem;font-weight:900;color:#0f172a;letter-spacing:-1.5px;margin-bottom:12px}.hero p{font-size:1.2rem;color:#475569;max-width:640px;margin:0 auto 24px}'+(phoneFmt?'.hero .cta{display:inline-flex;align-items:center;gap:10px;background:'+ac+';color:#fff;padding:16px 40px;border-radius:12px;font-size:1.1rem;font-weight:700;text-decoration:none;box-shadow:0 4px 14px '+ac+'44;transition:transform .2s}.hero .cta:hover{transform:translateY(-2px)}':'')+'section{max-width:840px;margin:0 auto;padding:48px 24px}section+section{border-top:1px solid #f1f5f9}.section-title{font-size:1.4rem;font-weight:800;color:#0f172a;margin-bottom:20px}p{margin-bottom:14px;font-size:18px;color:#334155}table{width:100%;border-collapse:collapse;margin:16px 0}td{padding:16px 14px;font-size:17px;border-bottom:1px solid #f1f5f9}td:first-child{font-weight:700;color:#64748b;width:180px}small{color:#64748b;font-size:15px;line-height:1.7}footer{background:#0f172a;color:#94a3b8;padding:32px;text-align:center;font-size:14px;margin-top:32px}footer strong{color:#e2e8f0}';
    return headHtml+'<style>'+css+'</style></head><body><nav><h1>'+displayName+'</h1><span>'+munFmt+'/'+ufFmt+'</span></nav><div class="hero"><h2 data-field="razao">'+razaoFmt+'</h2><p>'+(atividadeFmt||'Empresa regularmente constitu&iacute;da no Brasil')+'</p>'+(phoneFmt?'<a class="cta" data-field="phone">&#9742; '+phoneFmt+'</a>':'')+'</div><section><h3 class="section-title">Sobre a Empresa</h3>'+aboutNatural+'</section><section><h3 class="section-title">Informa&ccedil;&otilde;es Cadastrais</h3>'+tblData+'</section><section><h3 class="section-title">Canal de Atendimento</h3>'+contactNatural+'</section><section><h3 class="section-title">Pol&iacute;ticas e Conformidade</h3>'+complianceCompact+'</section><footer><strong>'+razaoFmt+'</strong><br>CNPJ '+cnpjFmt+' &mdash; '+munFmt+'/'+ufFmt+'</footer>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 1: ONE-PAGE MODERNO GRADIENTE ══════
  else if (layoutType === 1) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fafbfc;color:#1a1a1a;line-height:1.9;font-size:18px}.hero{min-height:50vh;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;padding:80px 24px;background:linear-gradient(160deg,'+ac+'08 0%,'+ac+'15 50%,#f8fafc 100%)}.hero h1{font-size:3.2rem;font-weight:900;color:#0f172a;letter-spacing:-2px;margin-bottom:12px}.hero .sub{font-size:1.1rem;color:#475569;margin-bottom:8px}.hero .meta{font-size:15px;color:#94a3b8}'+(phoneFmt?'.hero .btn{margin-top:28px;background:'+ac+';color:#fff;padding:18px 44px;border-radius:50px;font-size:1.2rem;font-weight:800;text-decoration:none;display:inline-block;font-family:monospace;box-shadow:0 8px 24px '+ac+'33}':'')+'main{max-width:760px;margin:0 auto;padding:48px 24px}h2{font-size:1.5rem;color:#0f172a;margin:44px 0 16px;font-weight:800;letter-spacing:-.5px}p{margin-bottom:16px;font-size:18px;color:#374151}table{width:100%;border-collapse:collapse;margin:16px 0;font-size:17px;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.05)}td{padding:16px 14px;border-bottom:1px solid #f1f5f9}td:first-child{font-weight:700;color:#64748b;width:180px;background:#f8fafc}small{color:#64748b;font-size:15px}footer{border-top:1px solid #e5e7eb;text-align:center;padding:32px;font-size:15px;color:#64748b;margin-top:48px}';
    return headHtml+'<style>'+css+'</style></head><body><div class="hero"><h1 data-field="razao">'+razaoFmt+'</h1><p class="sub">'+(atividadeFmt||'Empresa registrada e ativa')+'</p><p class="meta">'+munFmt+'/'+ufFmt+' &mdash; CNPJ '+cnpjFmt+'</p>'+(phoneFmt?'<a class="btn" data-field="phone">'+phoneFmt+'</a>':'')+'</div><main><h2>Quem Somos</h2>'+aboutNatural+'<h2>Dados da Empresa</h2>'+tblData+'<h2>Fale Conosco</h2>'+contactNatural+'<h2>Compromisso e Transpar&ecirc;ncia</h2>'+complianceCompact+'</main><footer>'+razaoFmt+' &bull; '+cnpjFmt+' &bull; '+munFmt+'/'+ufFmt+'</footer>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 2: CORPORATIVO DARK PREMIUM ══════
  else if (layoutType === 2) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#0a0f1a;color:#c8d6e5;line-height:1.9;font-size:18px}header{padding:20px 32px;border-bottom:1px solid #1e293b44;display:flex;justify-content:space-between;align-items:center}header h1{font-size:1.2rem;color:'+ac+';font-weight:700}header span{font-size:13px;color:#475569}.hero{padding:72px 32px;text-align:center;background:radial-gradient(ellipse at top,'+ac+'12 0%,transparent 60%)}.hero h2{font-size:3rem;font-weight:900;color:#f1f5f9;letter-spacing:-1.5px;margin-bottom:10px}.hero p{color:#94a3b8;font-size:1.1rem;margin-bottom:6px}'+(phoneFmt?'.hero .phone{font-family:monospace;color:'+ac+';font-size:1.6rem;font-weight:800;margin-top:20px;display:inline-block;padding:12px 28px;border:2px solid '+ac+'55;border-radius:12px;background:'+ac+'0a}':'')+'main{max-width:760px;margin:0 auto;padding:48px 24px}h3{color:'+ac+';font-size:13px;text-transform:uppercase;letter-spacing:3px;margin:40px 0 14px;font-weight:700}p{margin-bottom:14px;font-size:17px;color:#94a3b8}strong{color:#e2e8f0}table{width:100%;border-collapse:collapse;margin:14px 0;background:#111827;border-radius:12px;overflow:hidden}td{padding:16px 14px;border-bottom:1px solid #1e293b;font-size:16px;color:#cbd5e1}td:first-child{color:#64748b;font-weight:700;width:170px;background:#0f172a}small{color:#475569;font-size:15px}footer{text-align:center;padding:28px;font-size:14px;color:#334155;border-top:1px solid #1e293b;margin-top:32px}';
    return headHtml+'<style>'+css+'</style></head><body><header><h1>'+displayName+'</h1><span>'+situacaoFmt+'</span></header><div class="hero"><h2 data-field="razao">'+razaoFmt+'</h2><p>'+munFmt+'/'+ufFmt+' &mdash; CNPJ '+cnpjFmt+'</p>'+(phoneFmt?'<div class="phone" data-field="phone">'+phoneFmt+'</div>':'')+'</div><main><h3>A Empresa</h3>'+aboutNatural+'<h3>Registro</h3>'+tblData+'<h3>Contato via WhatsApp</h3>'+contactNatural+'<h3>Compliance</h3>'+complianceCompact+'</main><footer>'+razaoFmt+' &mdash; CNPJ '+cnpjFmt+'</footer>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 3: PORTAL COM SIDEBAR MODERNA ══════
  else if (layoutType === 3) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#f8fafc;color:#1e293b;line-height:1.9;font-size:17px;display:flex;min-height:100vh}@media(max-width:768px){body{flex-direction:column}}aside{width:300px;background:linear-gradient(180deg,#0f172a 0%,#1e293b 100%);color:#fff;padding:40px 24px;flex-shrink:0;display:flex;flex-direction:column}@media(max-width:768px){aside{width:100%;padding:24px}}aside h1{font-size:1.5rem;font-weight:800;margin-bottom:6px;color:#f8fafc}aside .cnpj{font-size:14px;color:#64748b;font-family:monospace;margin-bottom:20px}aside .info{font-size:14px;color:#94a3b8;line-height:1.8;margin-bottom:20px}'+(phoneFmt?'aside .phone{font-family:monospace;color:#fff;font-size:1.2rem;font-weight:800;background:'+ac+';padding:14px 20px;border-radius:10px;text-align:center;margin:16px 0}':'')+'aside nav{margin-top:auto;padding-top:20px;border-top:1px solid #334155}aside nav a{display:block;color:#94a3b8;text-decoration:none;padding:10px 0;font-size:14px;border-bottom:1px solid #1e293b55}aside nav a:hover{color:#fff}main{flex:1;padding:48px 36px;max-width:780px;overflow-y:auto}h2{font-size:1.4rem;color:#0f172a;margin:36px 0 14px;font-weight:800}p{margin-bottom:14px;font-size:17px;color:#475569}table{width:100%;border-collapse:collapse;margin:14px 0;background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.04)}td{padding:14px 12px;border-bottom:1px solid #f1f5f9;font-size:16px}td:first-child{font-weight:700;color:#64748b;width:170px;background:#f8fafc}small{color:#64748b;font-size:15px}';
    return headHtml+'<style>'+css+'</style></head><body><aside><h1 data-field="razao">'+razaoFmt+'</h1><div class="cnpj">'+cnpjFmt+'</div><div class="info">'+munFmt+'/'+ufFmt+'<br>'+situacaoFmt+'<br>'+(atividadeFmt||'')+'</div>'+(phoneFmt?'<div class="phone" data-field="phone">&#9742; '+phoneFmt+'</div>':'')+'<nav><a href="#">Sobre</a><a href="#">Dados</a><a href="#">Contato</a><a href="#">Pol&iacute;ticas</a></nav></aside><main><h2>Sobre a '+displayName+'</h2>'+aboutNatural+'<h2>Dados Cadastrais</h2>'+tblData+'<h2>Canal de Atendimento</h2>'+contactNatural+'<h2>Pol&iacute;ticas e Termos</h2>'+complianceCompact+'</main>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 4: EDITORIAL MAGAZINE ══════
  else if (layoutType === 4) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:Georgia,"Times New Roman",serif;background:#fff;color:#1a1a1a;line-height:2.1;font-size:19px}article{max-width:700px;margin:0 auto;padding:64px 24px}h1{font-size:2.8rem;font-weight:700;letter-spacing:-1.5px;margin-bottom:8px;color:#000;line-height:1.2}.byline{font-size:15px;color:#6b7280;margin-bottom:40px;font-family:system-ui,sans-serif;padding-bottom:20px;border-bottom:2px solid #111;display:flex;justify-content:space-between;flex-wrap:wrap;gap:8px}.byline span{background:#f1f5f9;padding:4px 12px;border-radius:4px;font-size:13px}h2{font-size:1.6rem;color:#000;margin:48px 0 16px;font-weight:700}p{margin-bottom:16px;font-size:19px;color:#374151}'+(phoneFmt?'.contact-box{background:linear-gradient(135deg,'+ac+'08,'+ac+'15);border:2px solid '+ac+'30;border-radius:16px;padding:28px;margin:28px 0;text-align:center}.contact-box p{font-family:system-ui,sans-serif;font-size:15px;color:#6b7280;margin-bottom:10px}.contact-box .num{font-family:monospace;font-size:1.8rem;color:'+ac+';font-weight:900;letter-spacing:1px}':'')+'small{color:#9ca3af;font-size:15px;font-family:system-ui,sans-serif;line-height:1.8}table{width:100%;border-collapse:collapse;margin:16px 0;font-family:system-ui,sans-serif}td{padding:14px 12px;border-bottom:1px solid #f1f5f9;font-size:16px}td:first-child{font-weight:700;color:#6b7280;width:170px}footer{font-family:system-ui,sans-serif;text-align:center;font-size:14px;color:#9ca3af;margin-top:56px;padding-top:20px;border-top:2px solid #111}';
    return headHtml+'<style>'+css+'</style></head><body><article><h1 data-field="razao">'+razaoFmt+'</h1><div class="byline"><span>'+munFmt+'/'+ufFmt+'</span><span>CNPJ '+cnpjFmt+'</span><span>'+situacaoFmt+'</span></div>'+aboutNatural+(phoneFmt?'<div class="contact-box"><p>WhatsApp Business &mdash; Canal Oficial</p><div class="num" data-field="phone">'+phoneFmt+'</div></div>':'')+'<h2>Dados Oficiais</h2>'+tblData+'<h2>Canal de Atendimento</h2>'+contactNatural+'<h2>Compliance e Privacidade</h2>'+complianceCompact+'<footer>'+razaoFmt+' &mdash; CNPJ '+cnpjFmt+'</footer></article>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 5: CARD DIGITAL PREMIUM ══════
  else if (layoutType === 5) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:linear-gradient(160deg,#0f172a 0%,#1e293b 50%,'+ac+'22 100%);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px}.card{background:#fff;max-width:560px;width:100%;border-radius:24px;box-shadow:0 25px 80px rgba(0,0,0,.25);overflow:hidden}.card-top{background:linear-gradient(135deg,'+ac+','+ac+'cc);padding:40px 32px;color:#fff;text-align:center}.card-top h1{font-size:2rem;font-weight:900;margin-bottom:6px}.card-top p{font-size:15px;opacity:.9}'+(phoneFmt?'.card-top .phone{font-family:monospace;font-size:1.4rem;font-weight:800;margin-top:16px;background:rgba(255,255,255,.2);display:inline-block;padding:12px 28px;border-radius:50px;backdrop-filter:blur(4px)}':'')+ '.card-body{padding:32px}.card-body p{font-size:17px;color:#475569;margin-bottom:12px;line-height:1.8}.card-body strong{color:#111}table{width:100%;border-collapse:collapse;margin:16px 0;font-size:16px}td{padding:14px 10px;border-bottom:1px solid #f1f5f9}td:first-child{color:#64748b;font-weight:700;width:150px}h3{font-size:1.1rem;color:#0f172a;margin:24px 0 12px;font-weight:700}small{color:#9ca3af;font-size:14px;line-height:1.7}.card-foot{background:#f8fafc;padding:16px 32px;text-align:center;font-size:13px;color:#64748b;border-top:1px solid #e2e8f0}';
    return headHtml+'<style>'+css+'</style></head><body><div class="card"><div class="card-top"><h1 data-field="razao">'+razaoFmt+'</h1><p>'+munFmt+'/'+ufFmt+' &mdash; CNPJ '+cnpjFmt+'</p>'+(phoneFmt?'<div class="phone" data-field="phone">&#9742; '+phoneFmt+'</div>':'')+'</div><div class="card-body"><h3>Sobre</h3>'+aboutNatural+'<h3>Dados</h3>'+tblData+'<h3>Atendimento</h3>'+contactNatural+'<small>'+priv+'</small></div><div class="card-foot">'+razaoFmt+' &mdash; '+cnpjFmt+'</div></div>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 6: CONSULTA OFICIAL / GOVERNO ══════
  else if (layoutType === 6) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#f5f5f4;color:#292524;line-height:1.8;font-size:17px}.header{background:#fff;border-bottom:3px solid '+ac+';padding:24px 32px;max-width:900px;margin:0 auto;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px}.header h1{font-size:1.3rem;font-weight:800;color:#0f172a;text-transform:uppercase;letter-spacing:.5px}.header .badge{font-size:12px;background:'+ac+';color:#fff;padding:6px 14px;border-radius:4px;font-weight:700}.body{max-width:900px;margin:0 auto;padding:32px;background:#fff;min-height:60vh}h2{font-size:15px;color:#0f172a;text-transform:uppercase;letter-spacing:1.5px;margin:32px 0 14px;padding-bottom:10px;border-bottom:2px solid #e5e7eb;font-weight:800}table{width:100%;border-collapse:collapse;margin:12px 0}th,td{text-align:left;padding:14px 12px;border:1px solid #e5e7eb;font-size:16px}th{background:#f8fafc;font-weight:800;color:#374151;width:190px}p{margin-bottom:12px;font-size:17px;color:#44403c}small{color:#78716c;font-size:15px}'+(phoneFmt?'.phone-highlight{font-family:monospace;color:'+ac+';font-weight:800;font-size:1.2rem}':'')+'footer{max-width:900px;margin:0 auto;text-align:center;padding:20px 32px;font-size:13px;color:#a8a29e;border-top:3px solid '+ac+';background:#fff}';
    return headHtml+'<style>'+css+'</style></head><body><div class="header"><h1 data-field="razao">'+razaoFmt+'</h1><span class="badge">'+situacaoFmt+'</span></div><div class="body"><h2>Dados do Estabelecimento</h2>'+tblData+'<h2>Informa&ccedil;&otilde;es da Empresa</h2>'+aboutNatural+'<h2>Canal de Comunica&ccedil;&atilde;o</h2>'+contactNatural+'<h2>Pol&iacute;tica de Privacidade e Termos</h2>'+complianceCompact+'</div><footer>'+razaoFmt+' &mdash; CNPJ '+cnpjFmt+' &mdash; '+munFmt+'/'+ufFmt+'</footer>'+domScript+'</body></html>';
  }

  // ══════ LAYOUT 7: LANDING PAGE CTA FULLSCREEN ══════
  else if (layoutType === 7) {
    var css='*{margin:0;padding:0;box-sizing:border-box}body{font-family:'+font+';background:#fff;color:#1e293b;line-height:1.9;font-size:18px}.hero{background:linear-gradient(135deg,'+ac+' 0%,'+ac+'bb 50%,'+ac+'88 100%);padding:80px 24px;text-align:center;color:#fff;position:relative;overflow:hidden}.hero::before{content:"";position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle,rgba(255,255,255,.1) 0%,transparent 60%);animation:none}.hero h1{font-size:3rem;font-weight:900;margin-bottom:10px;letter-spacing:-1px;text-shadow:0 2px 8px rgba(0,0,0,.2)}.hero p{font-size:1.2rem;opacity:.95;max-width:540px;margin:0 auto 24px}'+(phoneFmt?'.hero .btn{display:inline-block;background:#fff;color:'+ac+';padding:18px 44px;border-radius:50px;font-size:1.3rem;font-weight:900;font-family:monospace;text-decoration:none;box-shadow:0 8px 32px rgba(0,0,0,.2);transition:transform .2s}.hero .btn:hover{transform:scale(1.03)}':'')+'main{max-width:800px;margin:0 auto;padding:48px 24px}.section{margin:40px 0;padding:28px;background:#f8fafc;border-radius:16px;border:1px solid #e2e8f0}h2{font-size:1.4rem;color:#0f172a;margin-bottom:16px;font-weight:800}p{margin-bottom:14px;font-size:18px;color:#475569}table{width:100%;border-collapse:collapse;margin:12px 0}td{padding:14px 12px;border-bottom:1px solid #e2e8f0;font-size:17px}td:first-child{font-weight:700;color:#64748b;width:180px}small{color:#64748b;font-size:15px}footer{background:#0f172a;color:#94a3b8;text-align:center;padding:28px;font-size:14px}';
    return headHtml+'<style>'+css+'</style></head><body><div class="hero"><h1 data-field="razao">'+razaoFmt+'</h1><p>'+(atividadeFmt||'Empresa regularmente constitu&iacute;da')+' &mdash; '+munFmt+'/'+ufFmt+'</p>'+(phoneFmt?'<a class="btn" data-field="phone">&#9742; '+phoneFmt+'</a>':'')+'</div><main><div class="section"><h2>Sobre a Empresa</h2>'+aboutNatural+'</div><div class="section"><h2>Dados Oficiais</h2>'+tblData+'</div><div class="section"><h2>Atendimento via WhatsApp</h2>'+contactNatural+'</div><div class="section"><h2>Termos e Privacidade</h2>'+complianceCompact+'</div></main><footer>&copy; '+razaoFmt+' &mdash; CNPJ '+cnpjFmt+'</footer>'+domScript+'</body></html>';
  }
