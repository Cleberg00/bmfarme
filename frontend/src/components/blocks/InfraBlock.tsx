...
export default function InfraBlock({ clientId, razaoSocial, nomeFantasia, smsPhone, onDomainReady }: InfraBlockProps) {
  ...
  const netlifyDomains = isRonaldo
    ? ['mettaativos.com', 'verifcationbm.com.br', 'bmseven.com', 'veridesk1.com', 'veridesk2.com']
    : isAdmin
    ? ['perfilbr.com', 'validarfm.com', 'verificabussines.com', 'verificadorbm.com', 'validacaopf.com', 'ativoson.com', 'verifcationbm.com', 'perfilbr01.com', 'vericationbm.com', 'zaplifyativos01.com', 'zaplifyvalidation.com', 'zaplify01.com', 'zaplifydigital.com', 'zaplifyportifolio.com', 'zaplifybm08.com']
    : isMacumbinha
    ? ['verificabussines.com', 'validacaopf.com', 'verificacaobm02.com', 'zaplifybm02.com', 'zapbm02.com', 'zaplifybm04.com', 'bmzaplify02.com', 'bmzaplify03.com']
    : isZaplify
