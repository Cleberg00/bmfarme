...
export default function InfraBlock({ clientId, razaoSocial, nomeFantasia, smsPhone, onDomainReady }: InfraBlockProps) {
  ...
  const netlifyDomains = isRonaldo
    ...
    : isAdmin
    ? ['perfilbr.com', 'validarfm.com', 'verificabussines.com', 'verificadorbm.com', 'validacaopf.com', 'ativoson.com', 'verifcationbm.com', 'perfilbr01.com', 'vericationbm.com', 'zaplifyativos01.com', 'zaplifyvalidation.com', 'zaplify01.com', 'zaplifydigital.com', 'zaplifyportifolio.com', 'zaplifybm08.com', 'bmzaplifydigital.com', 'bmzaplify.com']
    : isMacumbinha
    ? ['zaplifybm10.com']
    : isZaplify
